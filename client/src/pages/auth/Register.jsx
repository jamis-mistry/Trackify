      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-24">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed max-w-lg">
            Join thousands of organizations using Trackify to transform their feedback loop. Create an account and get started in seconds.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-xl border border-white/50 dark:border-gray-700 rounded-3xl shadow-2xl p-8 md:p-10 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-500 dark:text-gray-400">Join Trackify to manage your complaints.</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-2">

                {/* Role Switcher */}
                <div className="bg-gray-100 dark:bg-gray-800/50 p-1.5 rounded-xl flex relative mb-8">
                  <motion.div
                    className="absolute top-1.5 bottom-1.5 bg-white dark:bg-gray-700 rounded-lg shadow-sm"
                    initial={false}
                    animate={{
                      x: role === "user" ? "0%" : role === "worker" ? "100%" : "200%",
                  ...
                  <button
                    type="button"
                    className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-bold relative z-10 transition-colors ${role === "user"
                  ...
                  <button
                    type="button"
                    className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-bold relative z-10 transition-colors ${role === "worker"
                      ? "text-indigo-600 dark:text-indigo-400"
                      : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                      }`}
                  ...
                  <button
                    type="button"
                    className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-bold relative z-10 transition-colors ${role === "organization"
                      ? "text-indigo-600 dark:text-indigo-400"
                      : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                      }`}
                ...
                <FloatingLabelInput
                  id="name"
                  type="text"
                  label={role === "organization" ? "Admin Name" : "Full Name"}
                  value={name}
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/30 flex items-center justify-center gap-2 transition-all disabled:opacity-70 disabled:cursor-not-allowed mt-4"
                >
                  {loading ? (
                    <>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-400 dark:text-gray-500">
              © {new Date().getFullYear()} Trackify. By creating an account, you agree to our Terms.
            </p>
          </div>
        </motion.div>
      </div>
